            ...
            @forelse ($users as $user)
                <tr>
                    ...
                    <td>
                        <div>
                            <!--begin::Toggle-->
                            <button type="button" class="btn btn-light btn-icon btn-sm rotate" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="30px, 30px">
